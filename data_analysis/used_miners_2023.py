##### This script gives a total number of USED miners sold and total paybles from miners in 2023
...
for column in data_sheet.iter_cols():
    ...
    if column_name == 'Product Type':
        for i, cell in enumerate(column):
            ...
            if i > 0 and cell.value == 'USED' and data_sheet.cell(row=i+1, column=7).value == 'Miner' and date > '2023-01-01' and date < '2023-12-31':
...
print(f'Total number of USED miners sold in 2023 are {total_number_miners_sold}')
print(f'Total paybles received from USED miners in 2023 are {total_paybles_from_miners}')
