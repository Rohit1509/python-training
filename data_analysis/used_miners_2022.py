##### This script gives a total number of USED miners sold and total paybles from miners in 2022
...
print(f'Total number of USED miners sold in 2022 are {total_number_miners_sold}')
print(f'Total paybles received from USED miners in 2022 are {total_paybles_from_miners}')
